...
import { Menu, X, BarChart, Search, HelpCircle, FileText, Rocket, ChevronRight } from "lucide-react";
...
const DashboardHeader = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 backdrop-blur-lg bg-white/5">
